...
// `book.publishedByLoad` is the owner's named set for that book -- the classes
// the load publishes in the same --apply that writes them. The projection has
// to model it: a class the load creates and publishes enters the catalogue in
