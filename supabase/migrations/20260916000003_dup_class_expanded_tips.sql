...
-- last rewritten is dropped by the fork. This revision adds expanded_tips
-- (20260916000002) to both the INSERT and SELECT lists so a fork carries it.
--
-- expanded_tips is copied unchanged, with no retarget parameter: forking a
