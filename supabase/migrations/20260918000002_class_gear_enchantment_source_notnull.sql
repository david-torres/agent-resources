...
-- `{"source":null}` all passed class_gear_enchantment_source_check and
-- class_gear_custom_enchantment_named_check unconstrained. coalesce() turns
-- that NULL into a plain string first so the comparison evaluates to TRUE or
-- FALSE, never NULL.
