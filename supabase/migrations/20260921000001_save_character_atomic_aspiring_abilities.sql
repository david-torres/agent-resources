...
-- characters.aspiring_abilities, added by
-- 20260921000000_characters_aspiring_abilities.sql (ENCLAVE: Aspirant V1,
-- pg. 90: an Aspiring character's Ability picks are treated as belonging to
-- its own Class).
--
...
--
-- Every block except the three touching aspiring_abilities is byte-identical
-- to 20260920000001_save_character_atomic_aspiring_signatures.sql.
